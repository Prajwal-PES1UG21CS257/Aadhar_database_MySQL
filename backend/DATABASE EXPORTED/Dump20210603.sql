...
CREATE TABLE `family1` (
  `uid_of_dependee` bigint NOT NULL,
  `relation` varchar(10) NOT NULL,
  `uid_of_dependent` bigint NOT NULL,
  PRIMARY KEY (`uid_of_dependee`,`uid_of_dependent`)
  CONSTRAINT `family_ibfk_1` FOREIGN KEY (`uid_of_dependent`) REFERENCES `aadhar_card` (`uid`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
